#!/usr/bin/env python3
"""
Create a solution guide for running SpeeDefender on port 5001
"""

solution_guide = """# SpeeDefender Port 5001 Solution Guide
...
with open('PORT_5001_SOLUTION.md', 'w') as f:
    f.write(solution_guide)

print("Solution guide created successfully at PORT_5001_SOLUTION.md")